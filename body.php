    ...
    <div class="container-fluid page bg-dark">
        ...
        <div class="row">
            <div class="accordion col col-6" id="accordionExample">
                <div class="card">
                    <div class="card-header bg-success pt-0" id="headingOne">
                        <h2 class="mb-0">
            ...
            <div class="accordion col col-6" id="accordionExample">
                <div class="card">
                    <div class="card-header bg-danger pt-0" id="headingTwo">
                        <h2 class="mb-0">
        ...
        <div class="bg-dark h-100">
            <div class="row h-100">
                <div class="col col-12 bg-dark h-100"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></div>
            </div>
        </div>
        <!-- Optional JavaScript -->
